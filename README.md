...
- **Cisco CCNA** — completing the full track (SRWE and ENSA following CCNA: ITN)

## Verification

All certifications listed above can be independently verified through one of the following:

1. **Credly** — the badge issuer's verification platform: [credly.com/users/david-ribeiro1](https://www.credly.com/users/david-ribeiro1)
2. **The PDF certificate** in this repository — provided as an offline reference copy.
